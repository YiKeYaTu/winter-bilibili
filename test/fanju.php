...
<body>
	...
	<div class="num">
		<div class="num_content">
			...
			<a class="focus" href="fanju.php">番剧</a>
			...
			<div class="search">
				<form style="float:right" action="search.php" method="post">
					<input type="text" name="text" name="text" placeholder="" class="form" />
	...
	<div class="center">
		<div class="center_content">
			...
			<div class="page" id="page">
				<!-- 从这里开始复制 这里是按热度顺序 -->
				<?php include "fanju_click.php"; ?>
				<!-- 到这里 -->
			</div>
			
			<div class="page" id="page_t">
				<!-- 从这里开始复制 这里是按时间顺序 -->
				<?php include "fanju_time.php"; ?>
				<!-- 到这里 -->
			</div>
