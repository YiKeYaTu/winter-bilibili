...
<?php
include "connect.php";
$sql = "select * from video where Video_tag = '电视剧' order by Video_click_num DESC";
$res = $dbh->prepare($sql);
$res->execute();
...
<div class="video_1">
<div class="item_1">
<a href="video.php?id=<?php echo$v['Video_id']; ?>"><!-- 这里的href这样写video.html?id=465这里的465是视频的ID你来写 -->
