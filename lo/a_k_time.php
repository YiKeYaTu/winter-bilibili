...
for($i=1;$i<=8;$i++) {
	$Cartoon = $arrayOne['Video_Time']."|".$Cartoon;
}
//Cartoon 部分数据
...
for($i=1;$i<=8;$i++){
	$TimeSeries =$arrayTwo['Video_Time']."|".$TimeSeries;
}
//番剧部分数据
...
for ($i=1;$i<=8;$i++) { 
	$Music =$numThree['Video_Time']."|".$Music;
}
//音乐部分数据  
...
for ($i=1;$i<=8;$i++) { 
	$Dance = $arrayFour['Video_Time']."|".$Dance;
}
//舞蹈部分
...
for ($i=1;$i<=8;$i++) { 
	$Game = $arrayFive['Video_Time']."|".$Game;
}
//游戏部分
...
for ($i=1;$i<=8;$i++) { 
	$Science = $arraySix['Video_Time']."|".$Science;
}
//科学技术部分
...
for ($i=1;$i<=8;$i++) { 
	$Entertainment = $arraySeven['Video_Time']."|".$Entertainment;
}
//娱乐部分
...
for ($i=1;$i<=8;$i++) { 
	$Hentai = $arrayEight['Video_Time']."|".$Hentai;
}
//鬼畜部分
...
for ($i=1;$i<=8;$i++) { 
	$Moive = $arrayNine['Video_Time']."|".$Moive;
}
//电影部分
...
for ($i=1;$i<=8;$i++) { 
	$TVplay = $arrayTen['Video_Time']."|".$TVplay;
}
//电视剧部分
$TimeOutput = $Cartoon."-".$TimeSeries."-".$Music."-".$Dance."-".$Game."-".$Science."-".$Entertainment."-".$Hentai."-".$Moive."-".$TVplay;
echo $TimeOutput;
?>