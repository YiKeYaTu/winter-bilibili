...
for($i=1;$i<=8;$i++) {
	$Cartoon = $arrayOne['Video_Introduction']."|".$Cartoon;
}
//Cartoon 部分数据
...
for($i=1;$i<=8;$i++){
	$TimeSeries =$arrayTwo['Video_Introduction']."|".$TimeSeries;
}
//番剧部分数据
...
for ($i=1;$i<=8;$i++) { 
	$Music =$numThree['Video_Introduction']."|".$Music;
}
//音乐部分数据  
...
for ($i=1;$i<=8;$i++) { 
	$Dance = $arrayFour['Video_Introduction']."|".$Dance;
}
//舞蹈部分
...
for ($i=1;$i<=8;$i++) { 
	$Game = $arrayFive['Video_Introduction']."|".$Game;
}
//游戏部分
...
for ($i=1;$i<=8;$i++) { 
	$Science = $arraySix['Video_Introduction']."|".$Science;
}
//科学技术部分
...
for ($i=1;$i<=8;$i++) { 
	$Entertainment = $arraySeven['Video_Introduction']."|".$Entertainment;
}
//娱乐部分
...
for ($i=1;$i<=8;$i++) { 
	$Hentai = $arrayEight['Video_Introduction']."|".$Hentai;
}
//鬼畜部分
...
for ($i=1;$i<=8;$i++) { 
	$Moive = $arrayNine['Video_Introduction']."|".$Moive;
}
//电影部分
...
for ($i=1;$i<=8;$i++) { 
	$TVplay = $arrayTen['Video_Introduction']."|".$TVplay;
}
//电视剧部分
$TagOutput = $Cartoon."-".$TimeSeries."-".$Music."-".$Dance."-".$Game."-".$Science."-".$Entertainment."-".$Hentai."-".$Moive."-".$TVplay;
echo $TagOutput;
?>