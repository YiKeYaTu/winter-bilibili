...
for($i=1;$i<=8;$i++) {
	$Cartoon = $arrayOne['Video_Up_Name']."|".$Cartoon;
}
//Cartoon 部分数据
...
for($i=1;$i<=8;$i++){
	$TimeSeries =$arrayTwo['Video_Up_Name']."|".$TimeSeries;
}
//番剧部分数据
...
for ($i=1;$i<=8;$i++) { 
	$Music =$numThree['Video_Up_Name']."|".$Music;
}
//音乐部分数据  
...
for ($i=1;$i<=8;$i++) { 
	$Dance = $arrayFour['Video_Up_Name']."|".$Dance;
}
//舞蹈部分
...
for ($i=1;$i<=8;$i++) { 
	$Game = $arrayFive['Video_Up_Name']."|".$Game;
}
//游戏部分
...
for ($i=1;$i<=8;$i++) { 
	$Science = $arraySix['Video_Up_Name']."|".$Science;
}
//科学技术部分
...
for ($i=1;$i<=8;$i++) { 
	$Entertainment = $arraySeven['Video_Up_Name']."|".$Entertainment;
}
//娱乐部分
...
for ($i=1;$i<=8;$i++) { 
	$Hentai = $arrayEight['Video_Up_Name']."|".$Hentai;
}
//鬼畜部分
...
for ($i=1;$i<=8;$i++) { 
	$Moive = $arrayNine['Video_Up_Name']."|".$Moive;
}
//电影部分
...
for ($i=1;$i<=8;$i++) { 
	$TVplay = $arrayTen['Video_Up_Name']."|".$TVplay;
}
//电视剧部分
$UpNameOutput = $Cartoon."-".$TimeSeries."-".$Music."-".$Dance."-".$Game."-".$Science."-".$Entertainment."-".$Hentai."-".$Moive."-".$TVplay;
echo $UpNameOutput;
?>