...
$Entertainment = "";
for ($i=1;$i<=1;$i++) { 
	$Entertainment = $arraySeven['Video_Id'];
}
//娱乐部分
...
$TVplay = "";
for ($i=1;$i<=1;$i++) { 
	$TVplay = $arrayTen['Video_Id'];
}
//电视剧部分
$RightIdOutput = $Cartoon."-".$TimeSeries."-".$Music."-".$Dance."-".$Game."-".$Science."-".$Entertainment."-".$Hentai."-".$Moive."-".$TVplay;
echo $RightIdOutput;
?>